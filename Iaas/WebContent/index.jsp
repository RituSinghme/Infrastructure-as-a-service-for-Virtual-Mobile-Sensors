...
<div class="jumbotron text-center">
  <h1>Mobile Sensing Infrastructure as a Service Platform</h1>
</div> 
<br>
<div class="container">
  <div class="row">
  <div class="col-sm-1" > </div>
    <div class="col-sm-4" >
    <h3> <a href ="index.jsp"> About Us </a></h3>      
      <p>We provide a cloud-based mobile sensing platform to collect Weather data</p>      
    </div>
    <div class="col-sm-3">
